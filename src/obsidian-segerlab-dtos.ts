...
export interface ObsidianCalculatorViewV1 {
  /** Id of the Calculation in the system. */
  calculationId: number;
  /** Id of the Recipe to which calculation belongs to. */
  recipeId: number;
  ...
  /** Calculation results. */
  calculationResult: ObsidianCalculationResultsV1;
}

export interface ObsidianIngredientFieldV1 {
  index: number;
  name: string;
  value: number;
  isAddition: boolean;
...
export interface ObsidianCalculationResultsV1 {
